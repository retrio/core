...
// unofficial
    ...
    public static inline var SLO:OpCode=63<<pos;
    public static inline var SRE:OpCode=64<<pos;
    public static inline var RRA:OpCode=65<<pos;
    public static inline var DCP:OpCode=66<<pos;
    public static inline var ISB:OpCode=67<<pos;
